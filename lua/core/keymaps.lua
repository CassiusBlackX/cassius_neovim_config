...
map({ 'n', 'x', 'o' }, 'gl', '$', { desc = "go to the end of the line" })
map({ 'n', 'x', 'o' }, 'gh', '0', { desc = "go to the head of the line" })
map({ 'n', 'x', 'o' }, 'ge', 'G', { desc = "go to the end of the file" })
map('n', 'gn', '<cmd>bnext<CR>', { desc = "go to next buffer" })
map('n', '<Leader>bn', '<cmd>bnext<CR>', { desc = "go to next buffer" })
map('n', 'gp', '<cmd>bprev<CR>', { desc = "go to buffer" })
